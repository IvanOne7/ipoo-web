...
ranking_local: {
    es: "🏙️ Ranking de tu ciudad",
    en: "🏙️ Your city's ranking",
    de: "🏙️ Rangliste deiner Stadt",
    fr: "🏙️ Classement de ta ville",
    it: "🏙️ Classifica della tua città",
  },
  ranking_global: {
    es: "🌍 Ranking global",
    en: "🌍 Global ranking",
    de: "🌍 Globale Rangliste",
    fr: "🌍 Classement mondial",
    it: "🌍 Classifica globale",
  },
  sin_ciudad: {
    es: "Pon tu ciudad en Ajustes para competir en tu zona.",
    en: "Set your city in Settings to compete in your area.",
    de: "Lege deine Stadt in den Einstellungen fest, um in deiner Gegend mitzumachen.",
    fr: "Renseigne ta ville dans les Paramètres pour concourir dans ta zone.",
    it: "Imposta la tua città nelle Impostazioni per competere nella tua zona.",
  },
logros_titulo: {
    es: "🏅 Logros",
    en: "🏅 Achievements",
  ...
  logro_primer_bano: {
    ...
    en: "First toilet",
    de: "Erste Toilette",
    fr: "Premières toilettes",
    it: "Primo bagno",
  },
  logro_cinco_banos: {
    es: "5 baños añadidos",
    en: "5 toilets added",
    de: "5 Toiletten hinzugefügt",
    fr: "5 toilettes ajoutées",
    it: "5 bagni aggiunti",
  },
  logro_diez_banos: {
    es: "10 baños añadidos",
    en: "10 toilets added",
    de: "10 Toiletten hinzugefügt",
    fr: "10 toilettes ajoutées",
    it: "10 bagni aggiunti",
  },
  logro_primera_valoracion: {
    es: "Primera valoración",
    en: "First review",
    de: "Erste Bewertung",
    fr: "Premier avis",
    it: "Prima recensione",
  ...
  logro_critico: {
    es: "Crítico (10 reseñas)",
    en: "Critic (10 reviews)",
    de: "Kritiker (10 Bewertungen)",
    fr: "Critique (10 avis)",
    it: "Critico (10 recensioni)",
  },
  logro_fotografo: {
    es: "Fotógrafo (5 fotos)",
    en: "Photographer (5 photos)",
    de: "Fotograf (5 Fotos)",
    fr: "Photographe (5 photos)",
    it: "Fotografo (5 foto)",
  },
  logro_explorador: {
    es: "Explorador (3 ciudades)",
    en: "Explorer (3 cities)",
    de: "Entdecker (3 Städte)",
    fr: "Explorateur (3 villes)",
    it: "Esploratore (3 città)",
  },
  logros_progreso: {
...
racha_titulo: {
  ...
  racha_animo: {
    es: "¡Vuelve mañana para no perderla!",
    en: "Come back tomorrow to keep it going!",
    de: "Komm morgen wieder, um sie zu halten!",
    fr: "Reviens demain pour la garder !",
    it: "Torna domani per non perderla!",
  },
compartir_rango: {
    es: "📢 Compartir mi rango",
    en: "📢 Share my rank",
    de: "📢 Meinen Rang teilen",
    fr: "📢 Partager mon rang",
    it: "📢 Condividi il mio grado",
  },
  compartir_texto: {
    es: "¡Soy {rango} en iPoo con {puntos} puntos! 🧻 Encuentra los mejores baños cerca de ti:",
    en: "I'm {rango} on iPoo with {puntos} points! 🧻 Find the best toilets near you:",
    de: "Ich bin {rango} bei iPoo mit {puntos} Punkten! 🧻 Finde die besten Toiletten in deiner Nähe:",
    fr: "Je suis {rango} sur iPoo avec {puntos} points ! 🧻 Trouve les meilleures toilettes près de toi :",
    it: "Sono {rango} su iPoo con {puntos} punti! 🧻 Trova i migliori bagni vicino a te:",
  },
  copiado: {
    es: "¡Copiado! Pégalo donde quieras.",
    en: "Copied! Paste it anywhere.",
    de: "Kopiert! Füge es überall ein.",
